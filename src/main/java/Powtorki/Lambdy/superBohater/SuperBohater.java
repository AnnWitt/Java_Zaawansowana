...
public class SuperBohater {
    public static void main(String[] args) {
        ...
        System.out.println("proba lamdb");
        InterfejsBohater KapitanLamdba=(imie,moc) -> System.out.println(imie.toUpperCase(Locale.ROOT) + " " + moc + " "+imie.length());
        KapitanLamdba.movBohatera("KapitanLamdba", "wkurwianie ludzi");
